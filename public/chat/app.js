...
function addBubble(role, text) { if (emptyState) emptyState.hidden = true; const el = document.createElement('div'); el.className = `bubble ${role}`; el.textContent = text; messages.append(el); messages.scrollTop = messages.scrollHeight; }
